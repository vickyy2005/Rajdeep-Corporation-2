            ...
            <ul className="mt-4 space-y-2.5">
              {footerLinks.products.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="group flex items-center text-xs sm:text-sm text-slate-450 hover:text-white transition-colors"
                  >
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a
                  ...
                  className="group flex items-center gap-3 text-xs sm:text-sm text-slate-450 hover:text-white transition-colors"
                >
              ...
              <li className="flex items-start gap-3 text-xs sm:text-sm text-slate-405">
