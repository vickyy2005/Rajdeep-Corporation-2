...
const categories = [
  {
    ...
    slug: 'pipes',
    description: 'High-grade DI, CI, MS, SS, and HDPE pipes engineered for municipal, industrial, and high-pressure networks.',
    icon: Cylinder,
    spec: 'DI, CI, MS, SS, HDPE Pipes',
  ...
  },
  {
    ...
    slug: 'fittings',
    description: 'A complete range of fittings including Socket, Mechanical Joint, Flanged, CID joints, and MS connection components.',
    icon: Wrench,
    spec: 'FI, DI, CI, MJ, CID, MS',
  ...
  },
  {
    ...
    slug: 'valves',
    description: 'High-performance Sluice, Butterfly, Air, Check, Pressure Relief, and Ball valves for precise system flow regulation.',
    icon: Gauge,
    spec: 'Air, Sluice, Butterfly, Check',
  ...
  },
  {
    ...
    slug: 'other',
    description: 'Essential components including Tyron/Flange/O-Rings, heavy-duty Nut Bolts, and custom MS/DI connection Flanges.',
    icon: Layers,
    spec: 'Rings, Nut Bolts, Flanges',
